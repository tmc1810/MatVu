    ...
    <hr>
      <div class="menu">
        <ul class="nav nav-pills flex-column mb-auto">
          ...
          <li class="nav-link"><a href="http://localhost/Noi_That/MatVu/User/TuyetLan/"><i class="fa-solid fa-eye"></i>Xem website</a></li>
          <li class="nav-link"><a href="http://localhost/Noi_That/MatVu/Dangnhap_Dangky/"><i class="fa-solid fa-right-from-bracket"></i>Đăng xuất</a></li>
        </ul>
      </div>
  </nav>
