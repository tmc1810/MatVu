    ...
    <hr>
      <div class="menu">
        <ul class="nav nav-pills flex-column mb-auto">
          <li class="nav-link"><a href="../Bang_dieu_khien/index.php"><i class="fa-solid fa-gauge"></i>Bảng điều khiển</a></li>
          <li class="nav-link"><a href="../Quan_li_danh_muc/index.php"><i class="fa-solid fa-clipboard"></i>Quản lý danh mục</a></li>
          <li class="nav-link"><a href="../Quan_li_san_pham/index.php"><i class="fa-solid fa-bag-shopping"></i>Quản lý sản phẩm</a></li>
          <li class="nav-link"><a href="../Quan_li_hang/index.php"><i class="fa-solid fa-earth-americas"></i>Quản lý hãng</a></li>
