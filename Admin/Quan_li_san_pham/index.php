                        ...
                        <tbody>
                            ...
                            <?php foreach($products as $product){ ?>
                                <tr class="odd">
                                    ...
                                    <a class="fa-solid fa-pen-to-square" href="sua_sanpham.php?id=<?php echo($product['id']) ?>"></a>&ensp;<a class="fa-solid fa-trash" href="xoa_sanpham.php?id=<?php echo($product['id']) ?>"></a>
                                    </td>
                                </tr>
                            <?php } 
