                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td style='width: 100px;' align='center'><a class='fa-solid fa-pen-to-square' href='sua_taikhoan.php?id=" . $row["id"] . "'></a>&emsp;<a class='fa-solid fa-trash' href='xoataikhoan.php?id=" . $row["id"] . "'></a></td>";
                                    echo "</tr>";
                                }
                            } else {
